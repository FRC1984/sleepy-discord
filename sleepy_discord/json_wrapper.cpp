...
const std::string optionalUInteger(const uint64_t num) { return num ? UInteger(num) : ""; }
...
const std::string optionalInteger(const int64_t num) { return num ? integer(num) : ""; }

const std::string boolean(const bool boolean) { return boolean ? "true" : "false"; }
} // namespace json
} // namespace SleepyDiscord
